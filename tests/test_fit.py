...
from psnailder import SpiralFitterMCMC, SpiralFitterMinimizer, calculate_rmse


@pytest.mark.parametrize("seed", range(3))
def test_gaussian_fit_improvement_mcmc(seed: int) -> None:
...
@pytest.mark.parametrize("seed", range(3))
def test_gaussian_fit_improvement_opt(seed: int) -> None:
    """ "Test that Gaussian distributed vertical phase space distributions have low improvement.
